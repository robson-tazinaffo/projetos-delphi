...
var
    ...
    V_STRTOKEN: String;
    V_CONECTADO : boolean;
    V_UltimaSincronia : TDateTime;
    V_ItemCadastrado : boolean;
    ...
    strModeloAparelho : String;
    strVersaoSO : String;
    strVersaoApp  : String;
    NomeApp : String;
    strDeviceToken : String; // tOKEN DO APARELHO


const
    C_COR_PADRAO        = $FFA1A390;
    C_COR_PADRAO_BOTAO  = $FF769C25;
