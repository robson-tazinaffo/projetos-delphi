{*******************************************************
 Esta Unit foi copiada de https://github.com/CarlosHe/AndroidPermission
 para suprir a necessidade de utilizacao da API 26 do Google

 Vide docupento de produto de Software RnFImp03 para mais informacoes
